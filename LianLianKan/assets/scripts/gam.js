cc.Class({
    ...
    properties: {
     ...
     initimageList:function(){
         ...
         this.imageList[14].getComponent(cc.Sprite).spriteFrame=this.y1SpriteFrame;
         this.imageList[14].getComponent('pic').num=1;
         this.imageList[15].getComponent(cc.Sprite).spriteFrame=this.y6SpriteFrame;
         this.imageList[15].getComponent('pic').num=6;
    },
    ...
    isLine:function(x1,x2,y1,y2,t_arrary){
        var self=this;
          this.display.string =x1+''+x2+''+y1+''+y2+'';
    ...
    update: function (dt) {
       // this.gameOver();
       this.display.string=this.duration-this.timer;
       if(this.total==0){
           gamePass();
       }
